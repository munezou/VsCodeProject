...
Specifically, if the lower quartile is  𝑄1  and the upper quartile is  𝑄3 , 
then the interquartile range  𝐼𝑄𝑅=𝑄3−𝑄1  (this is the box's height), and any score lower than  𝑄1−1.5×𝐼𝑄𝑅  is a flier,
 and so is any score greater than  𝑄3+1.5×𝐼𝑄𝑅 .
'''
plt.figure(figsize=(8, 4))
