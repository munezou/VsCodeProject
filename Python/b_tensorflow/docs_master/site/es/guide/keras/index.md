...
La guia [Keras: Una visi’Rn a’@pida](./overview.ipynb) te ayudara a empezar.
...
Para profundizar mas en la API, consulta el siguiente conjunto de gu’Las que cubren lo siguiente que necesitas saber como super usuario de TensorFlow Keras:

-   [Gu’La de la API funcional de Keras](./functional.ipynb)
-   [Guia de capacitaci’Rn y evaluacion](./train_and_evaluate.ipynb)
...
-   [Gu’La para enmascarar y acolchar (padding)](./masking_and_padding.ipynb)
